...
## Vấn đề: Hive Metastore không khởi động sau khi restart
...
**4. Query data:**
```bash
docker exec -it trino trino --server localhost:8081 --execute "SELECT COUNT(*) FROM hive.bronze.transactions"
```
